...
extern template RegistrationResult ICP2D_Point2Plane_cpu(std::vector<Vec2f> &model_pcd, const Scene_kdtree scene,
const ICPConvergenceCriteria criteria);
...
const ICPConvergenceCriteria criteria);
extern template RegistrationResult ICP2D_Point2Plane_cuda(device_vector_holder<Vec2f> &model_pcd, const Scene_kdtree scene,
const ICPConvergenceCriteria criteria);
#endif
